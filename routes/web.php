...
// Маршруты для работы с таблицей комплексов (Complex)
...
// Маршруты для работы с таблицей Установок (Plant)
Route::resource('plant', App\Http\Controllers\Plant\PlantController::class);
