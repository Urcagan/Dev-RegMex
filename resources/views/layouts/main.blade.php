...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <p class="animation__shake">RegMex</p>
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('main') }}" class="brand-link">
      <span class="brand-text font-weight-light">RegMex</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">VystropovDV</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022-{{ now()->year }} <a href="{{ route('main.index') }}">RegMex</a>.</strong>
    Все права защищены.
